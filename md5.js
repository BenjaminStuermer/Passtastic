 ...
 * wrapper function and made all the globally-declared variables local.
 * 
 * --------------------------------------------------------------------------------------
 * License: License to copy and use this software is granted provided that it is identified 
 * as the "RSA Data Security, Inc. MD5 Message-Digest Algorithm" in all material mentioning or 
 * referencing this software or this function. License is also granted to make and use 
 * derivative works provided that such works are identified as "derived from the RSA Data 
 * Security, Inc. MD5 Message-Digest Algorithm" in all material mentioning or referencing 
 * the derived work. 
 * 
